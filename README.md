...
YOLOv5 is one of the best available detectors. And we are proud to announce its full integration into [Supervisely Ecosystem](https://ecosystem.supervise.ly/). To learn more about how to use every app, please go to app's readme page (links are provided). Just add the apps to your team to start using them.
