...
7. [Export weights](../../../../supervisely-ecosystem/yolov5/supervisely/export_weights) - export weights to ONNX or TorchScript; also find python examples how to apply exported weights to an image and get predictions.
