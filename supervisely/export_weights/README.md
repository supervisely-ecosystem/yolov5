...
```
Pass torch_script_model_inference result through non_max_suppression: [explanation](https://towardsdatascience.com/non-maximum-suppression-nms-93ce178e177c),[source_code](https://github.com/supervisely-ecosystem/yolov5/blob/0138090cd8d6f15e088246f16ca3240854bbba12/utils/general.py#L455):
```
